    ...
    label{
 	...
 	<body>
 		<ul>
			...
			<li><a class="active" href="BuyerPortal.php">Πρόσθεσε προϊόν</a></li>
			...
			<li><a href="index.php">Αποσύνδεση</a><li>
 			...
 			<form name='add_product' method="POST" action="landing_page.php" >
				...
				<fieldset>
				<!--<div><input type="radio" class="radio" name="auctiontype" value="0" checked>
				<label for="auctiontype0">Πλειοδοτική</label><br>-->
				<div><input type="radio" class="radio" name="auctiontype" value="1" checked>
	  		...
	  		<label for="extensions">Επιτρέπονται οι παρατάσεις?</label><br>
					...
					<label>Αριθμός Παρατάσεων:</label> <input type="number" min="1" name="extnum" id="extnum" value="0" disabled><br> <label>*Οι Παρατάσεις είναι των 15 λεπτών!</label></br>
	 				<button class="button button1" type="submit" name="submit" value=15>Έναρξη Δημoπρασίας</button>
	 			</form>
	  	</body>
	</html>
