...
<html>
  ...
  <body>
  	 	<ul>
  			<li><a class="active" href="newOrder_Seller.php">Αναζήτηση προϊόντων</a></li>
  			<li><a href="userOrders.php">Οι παραγγελίες μου</a></li>
      ...
      <?php
			...
			if ($expire == false)
			{
				...
				echo "<form action='Listings.php'><button action='Listings_Seller.php'>Go Back</button></form>";
			}
        else{
          ?>
      ...
      <form method="POST" action="landing_page.php">
				<p>Εισάγεται την Προσφορά σας: <input type="number" max="<?php echo $price ?>" min="0" step="10" name="bid" id="bid" value="<?php echo $price ?>"><br></p>
        Εισάγεται την Διευθυνση σας: <input type="text" name='addr' value=""><br>

        <p><button type='submit' name='submit' value='14'>Place Bid</button></p>
      </form>
