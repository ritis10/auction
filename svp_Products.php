      ...
      <fieldset>
        ...
        while($row=mysqli_fetch_array($result)){
          ...
          echo '<td>'.$row['first_name']. ' ' .$row['last_name'].'</td>';
					...
					{
						echo "<td> <button  type='submit' name='Delete' value=".$row['auctionId']." disabled>Ακύρωση Δημοπρασίας</button></td>";
					}
					else {
						echo "<td> <button style='background-color:blue' type='submit' name='Delete' value=".$row['auctionId'].">Ακύρωση Δημοπρασίας</button></td>";
					}
          echo '</tr>';
        }
        echo '</table>';
